...
Configuration xWindowsOptionalFeature_Enable_Networking_Config_5 {
    ...
    Node "localhost" {
        $params | ForEach-Object {
            xWindowsOptionalFeature "Enable_Networking_$($_.Name)" {
                Name                 = $_.Name
                Ensure               = "Present"
...
# Invoke-DscConfiguration -ConfigurationName:"xWindowsOptionalFeature_Enable_Networking_Config_5"
