...
Configuration xWindowsOptionalFeature_Enable_Printing_Config_5 {
    ...
    Node "localhost" {
        $params | ForEach-Object {
            xWindowsOptionalFeature "Enable_Printing_$($_.Name)" {
                Name                 = $_.Name
                Ensure               = "Present"
...
# Invoke-DscConfiguration -ConfigurationName:"xWindowsOptionalFeature_Enable_Printing_Config_5"
